...
export const STR = {
  fa: {
    ...
    langBtn:"EN",
    mapTitle:"نقشه‌ی افسانه‌ها", mapHint:"روی هر استان بزن تا افسانه‌هایش را ببینی",
    sortBy:"مرتب‌سازی:", sortNew:"جدیدترین", sortPopular:"پربازدیدترین", sortAz:"الفبایی",
    readingTime:"دقیقه مطالعه", readingMode:"حالت مطالعه", exitReading:"خروج از حالت مطالعه",
    share:"اشتراک‌گذاری", copyLink:"کپی لینک", copied:"کپی شد!", telegram:"تلگرام", whatsapp:"واتساپ",
    listen:"روایت صوتی", related:"افسانه‌های مرتبط", comments:"نظرات",
    contributors:"مشارکت‌کنندگان", contributorsTitle:"مشارکت‌کنندگان افسانه‌ها",
    contributorsIntro:"سپاس از همه‌ی کسانی که افسانه‌های محلی‌شان را به اشتراک گذاشتند. نام هر نویسنده برای همیشه حفظ می‌شود.",
    legendsCount:"افسانه", views:"بازدید",
    season:"فصل", seasonAuto:"خودکار", seasonNone:"بدون جلوه", seasonYalda:"شب یلدا", seasonNowruz:"نوروز",
    offlineTitle:"آفلاین هستی", offlineText:"این صفحه هنوز ذخیره نشده. وقتی به اینترنت وصل شدی دوباره تلاش کن.",
    installApp:"نصب اپ"
  },
  en: {
    dir:"ltr", htmlLang:"en",
    ...
    langBtn:"فا",
    mapTitle:"Legend map", mapHint:"Tap a province to see its legends",
    sortBy:"Sort:", sortNew:"Newest", sortPopular:"Most viewed", sortAz:"A–Z",
    readingTime:"min read", readingMode:"Reading mode", exitReading:"Exit reading mode",
    share:"Share", copyLink:"Copy link", copied:"Copied!", telegram:"Telegram", whatsapp:"WhatsApp",
    listen:"Audio narration", related:"Related legends", comments:"Comments",
    contributors:"Contributors", contributorsTitle:"Afsaneha contributors",
    contributorsIntro:"Thanks to everyone who shared their local legends. Every author's name is preserved forever.",
    legendsCount:"legends", views:"views",
    season:"Season", seasonAuto:"Auto", seasonNone:"None", seasonYalda:"Yalda night", seasonNowruz:"Nowruz",
    offlineTitle:"You're offline", offlineText:"This page isn't saved yet. Reconnect and try again.",
    installApp:"Install app"
  }
};

export function getLang(){ return localStorage.getItem("afsaneha_lang") || "fa"; }
export function setLang(l){ localStorage.setItem("afsaneha_lang", l); }
export function getTheme(){ return localStorage.getItem("afsaneha_theme") || "dark"; }
export function setTheme(t){ localStorage.setItem("afsaneha_theme", t); document.documentElement.setAttribute("data-theme", t); }
export function applyDocLang(lang){ const s = STR[lang]; document.documentElement.lang = s.htmlLang; document.documentElement.dir = s.dir; }
